...
```bash
workflow --validate plugin/runbooks/git-commit.md
```
...
The workflow tool executes algorithmic workflows defined in `plugin/runbooks/`:

```bash
workflow plugin/runbooks/your-algorithm.md
```
