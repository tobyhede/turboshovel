...
Add import at top of `workflow-cli.ts`:
```typescript
import { runStep } from '../workflow/step-runner';
```

Replace the `next` command (lines 61-122):
...
**Files:**
- Modify: `plugin/hooks/README.md` (Workflow System section around line 436)

**Step 1: Update CLI Commands section**

Add execution options to the Quick Start (around line 436):
...
**Step 2: Add Command Execution section**

After the "Execution Paradigm" section (around line 435), add:
...
| 6 | Verification | tests, build, lint |
